...
3. **Palisade + gates.** Keep the wobbly ring. Open an EAST gate opposite the west one (3.2 m). Both gates get the swinging
   ...
   (Daniel 14:08–14:12): THREE timber platforms inside the palisade — one at each gate and one on the NORTH side — a
   plank deck whose floor sits just below the spike tips so a standing archer sees over the wall (deck ~2.6–2.8 m up for a
