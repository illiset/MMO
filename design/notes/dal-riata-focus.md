...
- BEACHES are a uniform pale-yellow sand ribbon (Daniel: "not what the beach looks like in Ireland"): Irish/PNW shores are rocky and varied — dark wet sand and shingle, wrack lines of kelp and driftwood, rock platforms and boulders running into the water, grassy dunes and machair behind, tide pools, cliffs at the headlands; sand only in a few sheltered strands. Narrow the sand band, break it with rock and shingle, wet-sand blend at the waterline, coastal scans for the platforms, headlands as cliffs.
- WATER IS A FLAT BLUE SHEET (sea and lake): no waves, no motion, no reflection, no depth colour, no shore foam, uniform blue. Needs a real water surface: animated waves (normal + displacement), depth-based colour going grey-green in the shallows and dark offshore (Atlantic under overcast, not tropical blue), reflections, foam at the shore, wet sand, refraction; the lake calmer with ripples. UE's Water plugin (ocean + lake + river bodies) is the fast path; Ultra Dynamic Sky's weather can drive wave strength later.
